...
//        print ("Class name aditi:", NSStringFromClass(self.classForCoder))
//        
//        if (NSStringFromClass(self.classForCoder) == "FinanceApp.ExpensesViewController") {
////                CleverTap.sharedInstance()?.recordEvent("ollectionView.clas")
//
//        } else if (NSStringFromClass(self.classForCoder) == "FinanceApp.PortfolioViewController") {
//            
//        } else if (NSStringFromClass(self.classForCoder) == "FinanceApp.PortfolioViewController") {
//            
//        }
//        
//        print ("Class name aditi agr:", String(describing: self)

        
//        CleverTap.sharedInstance()?.recordEvent(collectionView.clas)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if (NSStringFromClass(self.classForCoder) == "FinanceApp.ATCProfileViewController") {
            CleverTap.sharedInstance()?.recordEvent("Profile Viewed")
               }
...
extension ATCGenericCollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if(indexPath.row == 5){
            CleverTap.sharedInstance()?.recordEvent("User Logout")
        }
